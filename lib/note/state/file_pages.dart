...
import 'package:note/note/context-action/drive-context-actions.dart';
...
abstract class FilePage {
  ...
  FilePage({
    ...
    if (folder != null) {
      staticQueryParams['folderId'] = folder.documentId.toString();
    }
  }
...
class RootFolderPage extends FilePage {
  RootFolderPage() : super(
    ...
    //contextActions: [DriveContextAction.download,]
  );
}
